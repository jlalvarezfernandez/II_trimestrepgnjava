...
public class Tiempo {
  ...
  public Tiempo(int horas, int minutos, int segundos) throws DatosIntroducidosErroneos {
    ...
    if (Tiempo.tiempoCorrecto(horas, minutos, segundos)) {
      ...
      throw new DatosIntroducidosErroneos("Error al introducir los datos");
  ...
  /**
   * Método apra sumar minutos a un objeto d ela clase tiempo
